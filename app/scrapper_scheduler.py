...
from app.configuration import get_db_path, scrape_links, web_api_url, admin_password
...
def scrape_links_job():
    ...
    for link in scrape_links:
        ...
        post_request = requests.post(f"{web_api_url}/data/product/{product['store']}", data=product, auth=auth)
